...
uint32  TranslateFormat(DXGI_FORMAT type) {
  switch (type) {
    ...
    case DXGI_FORMAT_R32G32B32A32_FLOAT: return kRGBAn32;
    ...
    case DXGI_FORMAT_R32G32B32A32_SINT: return kIntVec4;
    ...
    case DXGI_FORMAT_R32G32B32A32_UINT: return kUintVec4;
    case DXGI_FORMAT_R32_SINT: return kBool;
    case DXGI_FORMAT_R32G32_SINT: return kBoolVec2;
    case DXGI_FORMAT_R32G32B32_SINT: return kBoolVec3;
    case DXGI_FORMAT_R32G32B32A32_SINT: return kBoolVec4;
    ...
    case DXGI_FORMAT_BC4_UNORM_SRGB: return kDXBC4nSRGB;
    ...
    case DXGI_FORMAT_BC5_UNORM_SRGB: return kDXBC5nSRGB;
